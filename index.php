        ...
        <div class="row"> 
          ...
          <div class="col-md-3">
            <div class="shop-sidebar"> 
              ...
              <!-- Part -->
              <?php include 'include/files/list-category.php'; ?>

              <!-- Accessories -->
              <?php include 'include/files/list-accessories.php'; ?>

              <!-- Vendors -->
              <?php include 'include/files/list-vendor.php'; ?>
          ...
          <div class="col-md-9" id="all-list">
           <div class="item-fltr"> 
              <div class="short-by">
                <?php include 'include/files/filter-vendor.php'; ?>
                <?php include 'include/files/filter-category.php'; ?>
            ...
            <div id="products" class="arrival-block col-item-3 list-group">
              <div class="row">
                ...
                <!-- Item -->
                <?php include 'include/files/item-list.php'; ?>
              </div>
            </div>
