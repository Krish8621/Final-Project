...
$sql = 'SELECT * FROM `user` WHERE `status` = 1 AND `level_id` = 3';
    ...
    <div class="cap-text">
    	<div class="item-name-new">
    		<div class="col-md-12" style="overflow: hidden;float:left;padding-left: 0;width:410px;">
    			<a href="./" data-id="$id" class="i-tittle">$name </a> 
    		</div>
  			
      		<span class="price">$address </span> 
      		<span class="price">$tech_city - $tech_district </span>
        	<!-- Details -->
      </div>
    </div>
  </div>
